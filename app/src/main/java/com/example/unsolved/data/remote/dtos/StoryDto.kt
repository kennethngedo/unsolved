...
data class StoryDto(
    ...
    fun toStoryEntity(): StoryEntity {
        return StoryEntity(
            ...
            intro_video = intro_video.map { it.toMedia() },
            main_character_id = main_character_id,
            name = name,
            price = price,
            short_summary = short_summary,
            story_id = story_id,
            list_image = list_image.map { it.toMedia() },
            preview_media = preview_media.map { it.toMedia() },
            ...
            background_image = background_image.map { it.toMedia() },
            created = created,
            genre_id = genre_id,
